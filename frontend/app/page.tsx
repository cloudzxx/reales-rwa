      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/20 flex items-center justify-center">
        ...
        <div className="bg-white/[0.04] backdrop-blur-xl border border-white/[0.08] rounded-2xl p-6">
          ...
          <dl className="space-y-4">
            ...
            <div>
              ...
              <dd className="text-sm font-mono text-blue-400/80 mt-0.5 break-all">{asset.contractAddress}</dd>
            </div>
          </dl>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={step} className="bg-white/[0.02] border border-white/[0.06] rounded-xl p-4">
              <span className="text-xs font-mono text-blue-400/60">{step}</span>
