  ...
  if (!asset) {
    return (
      <div className="py-24 text-center">
        <p className="text-red-500">Failed to load asset data. Is the Hardhat node running?</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg text-gray-500 mt-1">Real World Asset on-chain management</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-semibold text-gray-700">Asset Overview</h2>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-5">
            ...
            <h2 className="text-lg font-semibold text-gray-700">Token Supply</h2>
          </div>
          <dl className="space-y-5">
            <div className="flex gap-10">
            ...
            <div>
              <dt className="text-sm text-gray-400">Contract</dt>
